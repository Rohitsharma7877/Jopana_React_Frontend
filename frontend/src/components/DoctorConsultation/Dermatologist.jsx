...
import hairScalpImg from '../assets/Jimg19.jpeg'; 
import skinConsultImg from '../assets/Jimg20.jpeg';
...
const fetchDermatologyServices = () => {
      ...
      resolve([
        {
          ...
          duration: "20 mins",
          img: hairScalpImg,
          about: "Comprehensive hair and scalp treatment for hair fall, dandruff, and scalp conditions. Our dermatologists provide detailed scalp analysis and personalized treatment plans for healthy hair growth.",
          features: [
            "Scalp analysis for hair fall & dandruff",
            "Treatment plan with medication & lifestyle tips"
          ],
          packages: [
            { id: "p1", name: "Hair Revival Plan", desc: "Complete hair restoration program", tags: ["6 sessions", "3 months"], originalPrice: 5000, price: 3499, savings: "Save ₹1501", isPopular: true },
            { id: "p2", name: "Basic Scalp Care", desc: "Initial consultation & treatment", tags: ["2 sessions"], originalPrice: 1800, price: 1199, savings: "Save ₹601", isPopular: false }
          ],
          reviewSummary: { 
            rating: "4.80", total: "175K reviews", 
            bars: [{ stars: 5, pct: 89 }, { stars: 4, pct: 9 }, { stars: 3, pct: 2 }, { stars: 2, pct: 0 }, { stars: 1, pct: 0 }] 
          },
          reviewsList: [
            { id: 1, initial: "A", name: "Ankit R.", date: "May 2026", rating: 5, text: "Excellent hair treatment. My dandruff problem is completely gone after following the treatment plan." },
            { id: 2, initial: "P", name: "Priya S.", date: "Apr 2026", rating: 5, text: "Very detailed scalp analysis. Doctor prescribed effective medication for my hair fall." },
            { id: 3, initial: "R", name: "Rohit M.", date: "Mar 2026", rating: 4, text: "Good consultation. Seeing improvement in hair texture after 2 months of treatment." }
          ],
          howItWorks: [
            { time: "Immediately", title: "Scalp analysis", desc: "Detailed examination of scalp condition and hair health." },
            { time: "Within 24 hrs", title: "Diagnosis report", desc: "Receive detailed diagnosis and root cause analysis." },
            { time: "Within 3 days", title: "Treatment start", desc: "Begin prescribed medication and hair care routine." },
            { time: "Within 4 weeks", title: "Progress review", desc: "Follow-up to assess improvement and adjust treatment." }
          ],
          included: [
            { icon: "stethoscope", title: "Scalp examination", desc: "Complete scalp & hair follicle analysis" },
            { icon: "heartbeat", title: "Hair health assessment", desc: "Check hair density & growth patterns" },
            { icon: "prescription", title: "Prescription", desc: "Medication & topical treatment plan" },
            { icon: "phone", title: "Follow-up call", desc: "One free follow-up within 4 weeks" }
          ],
          excluded: [
          ...
          faqs: [
            { question: "How long does it take to see results?", answer: "Typically 4-8 weeks of consistent treatment to see visible improvement in hair condition." },
            { question: "Do you prescribe oral medications?", answer: "Yes, depending on the diagnosis, we may prescribe oral medications along with topical treatments." },
            { question: "Is the treatment safe for all ages?", answer: "Yes, our treatments are safe and customized based on age and specific condition." }
          ],
          professionals: [
        ...
        },
        {
          ...
          duration: "25 mins",
          img: skinConsultImg,
          about: "Expert skin consultation for acne, pigmentation, rashes, and other skin concerns. Our dermatologists provide comprehensive skin analysis and personalized skincare routines for healthy, glowing skin.",
          features: [
            "Examination of rashes, acne & pigmentation issues",
            "Personalized skincare routine & prescription"
          ],
          packages: [
            { id: "p3", name: "Glow Skin Plan", desc: "Complete skin rejuvenation program", tags: ["8 sessions", "4 months"], originalPrice: 6000, price: 4299, savings: "Save ₹1701", isPopular: true }
          ],
          reviewSummary: { 
            rating: "4.84", total: "390K reviews", 
            bars: [{ stars: 5, pct: 93 }, { stars: 4, pct: 6 }, { stars: 3, pct: 1 }, { stars: 2, pct: 0 }, { stars: 1, pct: 0 }] 
          },
          reviewsList: [
            { id: 1, initial: "M", name: "Meera K.", date: "May 2026", rating: 5, text: "Amazing skin consultation. My acne has cleared up significantly after following the prescribed routine." },
            { id: 2, initial: "S", name: "Sneha P.", date: "Apr 2026", rating: 5, text: "Very thorough skin analysis. Doctor identified my skin type correctly and suggested perfect products." }
          ],
          howItWorks: [
            { time: "Immediately", title: "Skin analysis", desc: "Detailed examination of skin type, texture, and concerns." },
            { time: "Within 24 hrs", title: "Skincare plan", desc: "Personalized skincare routine and product recommendations." },
            { time: "Within 3 days", title: "Treatment start", desc: "Begin prescribed medications and skincare regimen." },
            { time: "Within 3 weeks", title: "Glow check", desc: "Follow-up to review skin improvement and adjust routine." }
          ],
          included: [
            { icon: "stethoscope", title: "Skin examination", desc: "Complete skin type & condition analysis" },
            { icon: "heartbeat", title: "Acne assessment", desc: "Identify acne type and severity" },
            { icon: "prescription", title: "Prescription", desc: "Medicated creams & oral medication if needed" }
          ],
          excluded: [
            "Chemical peels",
            "Laser treatments",
          ...
          faqs: [
            { question: "What skin conditions do you treat?", answer: "We treat acne, pigmentation, eczema, psoriasis, rashes, and general skin health concerns." },
            { question: "Will I get product recommendations?", answer: "Yes, we recommend medical-grade and OTC products suitable for your skin type." }
          ],
          professionals: [
            { icon: "graduation-cap", text: "Dermatology specialists" },
            { icon: "star", text: "4.8+ average ratings" },
...
const Dermatologist = () => {
  ...
  useEffect(() => {
    fetchDermatologyServices().then((data) => { 
