...
import sinusAllergyImg from '../assets/Jimg17.jpeg'; 
import entCheckupImg from '../assets/Jimg18.jpeg';
      ...
      resolve([
        {
          ...
          duration: "20 mins",
          img: sinusAllergyImg,
          about: "Comprehensive sinus and allergy consultation for chronic sinusitis, seasonal allergies, and nasal congestion. Our ENT specialists provide thorough examination and personalized treatment plans.",
          features: [
            "Chronic sinus & seasonal allergy assessment",
            "Nasal spray, medication & lifestyle advice"
          ],
          packages: [
            { id: "p1", name: "Allergy Relief Plan", desc: "Complete allergy management program", tags: ["5 visits", "3 months"], originalPrice: 3000, price: 1999, savings: "Save ₹1001", isPopular: true },
            { id: "p2", name: "Basic Sinus Care", desc: "Initial consultation & treatment", tags: ["2 visits"], originalPrice: 1200, price: 799, savings: "Save ₹401", isPopular: false }
          ],
          reviewSummary: { 
            rating: "4.79", total: "124K reviews", 
            bars: [{ stars: 5, pct: 88 }, { stars: 4, pct: 10 }, { stars: 3, pct: 2 }, { stars: 2, pct: 0 }, { stars: 1, pct: 0 }] 
          },
          reviewsList: [
            { id: 1, initial: "P", name: "Priya M.", date: "May 2026", rating: 5, text: "Excellent sinus treatment. Doctor was very thorough and the medication worked perfectly." },
            { id: 2, initial: "R", name: "Rahul S.", date: "Apr 2026", rating: 5, text: "Great allergy consultation. Finally got relief from my chronic sinus issues." },
            { id: 3, initial: "A", name: "Ananya K.", date: "Mar 2026", rating: 4, text: "Good experience. Doctor explained everything clearly and provided helpful advice." }
          ],
          howItWorks: [
            { time: "Immediately", title: "Symptom assessment", desc: "Detailed evaluation of sinus and allergy symptoms." },
            { time: "Within 24 hrs", title: "Diagnosis & plan", desc: "Receive diagnosis and personalized treatment plan." },
            { time: "Within 3 days", title: "Medication start", desc: "Begin prescribed medications and nasal care routine." },
            { time: "Within 2 weeks", title: "Follow-up review", desc: "Check progress and adjust treatment if needed." }
          ],
          included: [
            { icon: "stethoscope", title: "ENT examination", desc: "Complete ear, nose & throat checkup" },
            { icon: "heartbeat", title: "Allergy testing", desc: "Identify specific allergy triggers" },
          ...
          faqs: [
            { question: "How do you diagnose sinusitis?", answer: "Through physical examination, nasal endoscopy, and reviewing your symptoms and medical history." },
            { question: "Can allergies be cured permanently?", answer: "While allergies can't always be cured, they can be effectively managed with proper treatment and lifestyle changes." },
            { question: "Do I need any tests before consultation?", answer: "No specific tests required. Bring any previous reports if available." }
          ],
          professionals: [
            { icon: "graduation-cap", text: "Trained for 100+ hours" },
            { icon: "star", text: "4.7+ average ratings" },
            { icon: "shield-check", text: "Background verified" }
          ]
        },
        {
          id: 2,
          title: "Ear, Nose & Throat Checkup",
          rating: "4.83",
          reviews: "98K reviews",
          price: 549,
          originalPrice: 749,
          ...
          duration: "25 mins",
          img: entCheckupImg,
          about: "Complete ear, nose, and throat examination for infections, hearing issues, and throat problems. Our ENT specialists provide comprehensive care with detailed diagnosis and treatment.",
          features: [
            "Examination for infections, allergies & blockages",
            "Hearing test referral & medication plan"
          ],
          packages: [
            { id: "p3", name: "Complete ENT Care", desc: "Full ENT health management", tags: ["6 visits", "4 months"], originalPrice: 4000, price: 2999, savings: "Save ₹1001", isPopular: true }
          ],
          reviewSummary: { 
            rating: "4.83", total: "98K reviews", 
            bars: [{ stars: 5, pct: 91 }, { stars: 4, pct: 7 }, { stars: 3, pct: 2 }, { stars: 2, pct: 0 }, { stars: 1, pct: 0 }] 
          },
          reviewsList: [
            { id: 1, initial: "S", name: "Suresh P.", date: "May 2026", rating: 5, text: "Thorough ENT checkup. Doctor identified my ear infection quickly and prescribed effective treatment." },
            { id: 2, initial: "M", name: "Meera T.", date: "Apr 2026", rating: 5, text: "Great experience. The doctor was very patient and explained everything in detail." }
          ],
          howItWorks: [
            { time: "Immediately", title: "Complete ENT exam", desc: "Thorough examination of ears, nose, and throat." },
            { time: "Within 24 hrs", title: "Test referrals", desc: "Hearing test or imaging referrals if needed." },
            { time: "Within 3 days", title: "Treatment start", desc: "Begin prescribed treatment plan." },
            { time: "Within 10 days", title: "Progress check", desc: "Follow-up to ensure treatment effectiveness." }
          ],
          included: [
            { icon: "stethoscope", title: "ENT examination", desc: "Complete ear, nose & throat assessment" },
            { icon: "heartbeat", title: "Hearing screening", desc: "Basic hearing evaluation" },
            { icon: "prescription", title: "Medication plan", desc: "Prescription for infections & allergies" }
          ],
          excluded: [
            "Audiometry tests",
          ...
          faqs: [
            { question: "What does an ENT checkup include?", answer: "It includes examination of ears, nose, throat, and neck. The doctor checks for infections, blockages, and other abnormalities." },
            { question: "Do I need a hearing test?", answer: "If you have hearing concerns, the doctor may recommend a hearing test at a specialized center." }
          ],
          professionals: [
            { icon: "graduation-cap", text: "ENT specialists" },
