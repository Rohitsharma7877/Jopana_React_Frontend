...
import elderlyCareImg from '../assets/Jimg13.jpeg'; 
import babyCareImg from '../assets/Jimg14.jpeg';
import dailyChoresImg from '../assets/Jimg15.jpeg';
import patientAttendantImg from '../assets/Jimg16.jpeg';
import hygieneAssistImg from '../assets/Jimg25.jpeg';
...
const HomeAssistance = () => {
  ...
  const mainServicesData = [
    { id: 1, title: "Elderly Care Support", img: elderlyCareImg, rating: "4.92", reviews: "12k", price: 599, oldPrice: 800 },
    { id: 2, title: "Baby & Mother Care", img: babyCareImg, rating: "4.88", reviews: "8.5k", price: 750, oldPrice: "" },
    { id: 3, title: "Daily Chores Assistance", img: dailyChoresImg, rating: "4.50", reviews: "15k", price: 300, oldPrice: "" },
    { id: 4, title: "24/7 Patient Attendant", img: patientAttendantImg, rating: "4.95", reviews: "10k", price: 899, oldPrice: 1200 },
    { id: 5, title: "Hygiene & Bath Assist", img: hygieneAssistImg, rating: "4.60", reviews: "6k", price: 350, oldPrice: 450 },
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-[40px] gap-[20px] md:gap-0">
            <div className="text-left">
              ...
              <p className="text-[#7a8a9e] text-[15px] md:text-[16px] m-0 font-[500] font-['Segoe_UI',Tahoma,Geneva,sans-serif]">
                Compassionate care and support for daily living
              </p>
            </div>
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-[20px] md:mb-[30px] pb-[15px] md:pb-[20px] border-b-[1px] border-[#eef2f6]">
                <h2 className="text-[24px] md:text-[32px] font-[900] text-[#273b47] m-0">All Home Assistance Services</h2>
