...
import newbornCareImg from '../assets/Jimg13.jpeg'; 
import pregnantCheckupImg from '../assets/Jimg14.jpeg';
import lactationImg from '../assets/Jimg15.jpeg';
import postnatalImg from '../assets/Jimg16.jpeg';
import newbornMonthlyImg from '../assets/Jimg25.jpeg';
...
const MotherChildCare = () => {
  ...
  const mainServicesData = [
    { id: 1, title: "Newborn Care", img: newbornCareImg, rating: "4.97", reviews: "9.2k", price: 449, oldPrice: 500 },
    { id: 2, title: "Pregnant Mother Checkup", img: pregnantCheckupImg, rating: "4.73", reviews: "5.3k", price: 600, oldPrice: "" },
    { id: 3, title: "Lactation Support", img: lactationImg, rating: "4.37", reviews: "22k", price: 750, oldPrice: "" },
    { id: 4, title: "Postnatal Care", img: postnatalImg, rating: "4.97", reviews: "9.2k", price: 349, oldPrice: 600 },
    { id: 5, title: "Newborn Monthly Checkup", img: newbornMonthlyImg, rating: "4.27", reviews: "26k", price: 249, oldPrice: 500 },
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-[40px] gap-[20px] md:gap-0">
            <div className="text-left">
              ...
              <p className="text-[#7a8a9e] text-[15px] md:text-[16px] m-0 font-[500] font-['Segoe_UI',Tahoma,Geneva,sans-serif]">
                Gentle care for new mothers and precious little ones
              </p>
            </div>
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-[20px] md:mb-[30px] pb-[15px] md:pb-[20px] border-b-[1px] border-[#eef2f6]">
                <h2 className="text-[24px] md:text-[32px] font-[900] text-[#273b47] m-0">All Mother and Child Care Services</h2>
